...
class UserSettings(Base):
    ...
    notif_report_reviewed: Mapped[bool] = mapped_column(Boolean, nullable=False, default=True)
    notif_photo_liked: Mapped[bool] = mapped_column(Boolean, nullable=False, default=True)
